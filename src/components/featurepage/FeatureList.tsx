    ...
    <div className="max-w-6xl mx-auto px-4">
      ...
      <div className="mb-12">
        <div className="flex flex-col items-start gap-2">
          <div className="text-2xl md:text-3xl font-bold text-dark">Fitur Utama</div>
          <span className="inline-block text-sm font-bold text-green-700 bg-green-200/80 px-4 py-1 rounded-full">Mobile App</span>
        </div>
      </div>

      <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-16 mb-20">
        <div className="w-full md:w-1/2 flex flex-col items-start justify-center">
          <div className="mb-4">{iconMap[features[0].icon]}</div>
      ...
      <div className="flex flex-col md:flex-row-reverse items-center md:items-start gap-8 md:gap-16 mb-20">
        <div className="w-full md:w-1/2 flex flex-col items-start justify-center">
          <div className="mb-4">{iconMap[features[1].icon]}</div>
          ...
          <img src="/ipadpembayaran.png" alt="Pembayaran" className="w-[400px] max-w-full rounded-2xl shadow-xl border border-green-100" />
            ...
            <div className="flex flex-col md:flex-row items-center md:items-stretch gap-8 md:gap-16 mb-16">
              <div className="w-full md:w-1/2 flex flex-col justify-center items-start md:pr-8">
                <div className="mb-4">{iconMap[features[2].icon]}</div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch gap-8 md:gap-16 mb-16">
              <div className="w-full md:w-1/2 flex flex-col justify-center items-start md:pl-8">
                <div className="mb-4">{iconMap[features[3].icon]}</div>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-stretch gap-8 md:gap-16 mb-16">
              <div className="w-full md:w-1/2 flex flex-col justify-center items-start md:pr-8">
                <div className="mb-4">{iconMap[features[4].icon]}</div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center md:items-stretch gap-8 md:gap-16 mb-16">
              <div className="w-full md:w-1/2 flex flex-col justify-center items-start md:pl-8">
                <div className="mb-4">{iconMap[features[5].icon]}</div>
              ...
              <div className="w-full md:w-1/2 flex justify-center items-center bg-white">
                ...
                <div className="flex flex-col items-start gap-2 mb-6">
                  <span className="inline-block text-base font-bold text-white bg-[#7CFF00] px-6 py-2 rounded-[10px] shadow-lg" style={{boxShadow:'0px 38.5px 25.5px rgba(68,68,68,0.06), 0px 20px 13px rgba(68,68,68,0.05), 0px 8.15px 6.52px rgba(68,68,68,0.039), 0px 1.85px 3.15px rgba(68,68,68,0.024)'}}>List Order Management (Kitchen)</span>
                </div>
